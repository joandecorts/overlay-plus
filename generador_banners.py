...
def generar_banners_individuals(metadades, periode_data, diari_data):
    ...
    for estacio_id, meta in metadades.items():
        ...
        html = HTMLGenerator.generar_head(f"{periode.get('NOM_ESTACIO', estacio_id)}")
    ...
    <div class="meteo-overlay">
        <div class="overlay-header">
            <div class="station-info">
                ...
                <div class="location-details">
                    {meta.get('comarca', '')} | {meta.get('altitud', '')} m | ID: {estacio_id}
                </div>
            </div>
        ...
        html += f'''
                    ...
                    <div class="station-icon">
                        <a href="banner.html" title="Totes">
                            <i class="fas fa-list"></i>
                ...
                <div class="rotation-status-container">
                    <div class="rotation-status">
                        ...
                        Prem "Totes" per canviar d'estació
                    </div>
                </div>
            </div>
        ...
        print(f"   ✅ {estacio_id} → {output_path.name}")
    
    print(f"✅ {len(banners_generats)} banners individuals")
